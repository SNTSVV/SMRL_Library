    ...
    for (final Action action : _actions) {
      {
        ...
        {
          ifThenBlock();
          if (((Operations.urlOfActionChangesOverMultipleExecutions(action) && Operations.EQUAL(Operations.Input(2), Operations.addAction(Operations.Input(1), pos, action))) && Operations.Input(2).actions().get(pos).setId(""))) {
            ifThenBlock();
